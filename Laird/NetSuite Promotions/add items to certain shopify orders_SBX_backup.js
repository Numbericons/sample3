...
define(['N/error','N/search','N/record','N/workflow','N/runtime'],function(error,search,record,workflow,runtime) {
  function afterSubmit(context) {
    ...
    //**** CURRENT PROMO DETAILS BELOW - MAY 18, 2022
    var specifiedOrderCount = 1;
    ...
    if (channelText=='Shopify'){
      ...
      var promoOneAddItemToOrder = 1; //adding a variable name more consistent with promo 2 handling, this exclusion approach assumes we add the item until we find a condition that invalidates that assumption
      ...
      if(promoOneAddItemToOrder==1 || promoTwoAddItemToOrder==1){
        if(promoOneAddItemToOrder==1){
