define(
  ...
  function (record, log, search, dialog) {
    ...
    */
    ...
    function newLine(currentRecord) {
    ...
    function accountChange(currentRecord, source) {
      ...
      var currLine = currentRecord.getCurrentSublistIndex({sublistId: 'line'}) + 1;
      var lines = currentRecord.getLineCount({sublistId: 'line'});

      if (lines >= currLine) {
        console.log('accountChange: currLine >= currLine is true!');
        return newLine(currentRecord, currLine);
      }
