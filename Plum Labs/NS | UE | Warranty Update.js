...
////Set sales order record to dynamic
...
log.debug('lines?', 'Line ' + i + 'lineCount' + (itemLineCount - 1))
                        if (isPlumCase && i == (itemLineCount - 1)){
                            plumIncluded = true;
                          log.debug('plumIncluded?', plumIncluded)
                        }
                        ...
                        if (isPlumCase && i != (itemLineCount - 1)) {
                            ...
                            plumIncluded = true;
log.debug('plumIncluded?2', plumIncluded)
                            ...
                            if (extraWarranty || ncmLicenseItem) {
                                log.debug(stLogTitle, 'Extra Warranty included for line: ' + i);
                                ...
                                warrantyInMonths = parseFloat(warrantyInMonths);
                ...
                if(!isEmpty(totalAdditionalWarranty)) {
                    //if (additionalWarranty > 0) {
                        if(!isEmpty(arrPlumData[i].ncmDate)) {
                            ...
                            var ncmDate = new Date(ncmDate.setMonth(ncmDate.getMonth() + additionalWarranty));
                        }
                        else{
