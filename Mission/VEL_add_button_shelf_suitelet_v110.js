    ...
    define(['N/file', 'N/record', 'N/render', 'N/search'],
        ...
        (file, record, render, search) => {
            ...
            const createText = (itemRec) => {
                ...
                // text += '</tr><tr>';
                text += `<td colspan="1" height= "60px" style="font-size: 16pt; margin-left: -80px; margin-top: -20px;">${item.unitText}</td>`;
                // text += '</tr><tr>';
                ...
                text += '</tr><tr>';
                text += `<td colspan="1" height= "60px" style="font-size: 14pt; margin-top: -115px;">${item.id}</td>`;
                text += '</tr>';
