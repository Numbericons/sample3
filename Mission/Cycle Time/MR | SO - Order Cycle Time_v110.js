  ...
  define(
    ...
    (record, search, runtime, error) => {
      ...
      function setChildValues(object, id, estimateId) {
        ...
        object['custbody_vel_if_date_picked'] = adjustDate(fulfillArr[0].getValue({
          name: 'tranpickeddate'
        }));
      ...
      function searchRelatedTrans(type, id) {
        ...
        return search.create({
          ...
          [
              ...
              search.createColumn({name: "transhippeddate", label: "Shipped Date"})
          ]
        });
      }
      ...
      function searchCreate() {
        return search.create({
          ...
          [
              ...
              ["mainline","is","T"],
              "AND",
              ["custbody_vel_invoice_create_date","isempty",""],
              "AND",
              ["createdfrom.type","anyof","Estimate"],
              "AND",
              ["datecreated","within","1/1/2022 12:00 am","1/7/2022 11:59 pm"]
          ],
          columns:
          [
              search.createColumn({name: "internalid", label: "Internal ID"}),
