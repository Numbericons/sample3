    ...
    (record, search, runtime, error) => {
      ...
      function setChildValues(object, id, estimateId) {
        ...
        fulfillmentSearch.run().each(function(result) {
          object['custbody_vel_if_creation_date'] = adjustDate(result.getValue({
              name: 'datecreated'
          }));
          log.debug('IF created date: ', object['custbody_vel_if_creation_date']);
          
          object['custbody_vel_if_date_picked'] = adjustDate(result.getValue({
            name: 'tranpickeddate'
          }));
          
          log.debug('IF picked date: ', object['custbody_vel_if_date_picked']);

          object['custbody_vel_if_date_shipped'] = adjustDate(result.getValue({
        ...
        invoiceSearch.run().each(function(result) {
          object['custbody_vel_invoice_create_date'] = adjustDate(result.getValue({
              name: 'datecreated'
          }));
