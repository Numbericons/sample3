...
define(
    ...
    function (record, format, currentRecord, runtime, search, nts_md_manage_price_rule,
         ...
         * The process ends
         */
        function item_pricing(estimate, price_rule, trandate, domestic, international, customerTxt) {
            log.debug('Enter item_pricing');
            log.debug('price_rule : ' + price_rule);
            ...
            if (!isEmpty(price_rule)) {
                ...
                log.debug('alt_price_rule : ' + alt_price_rule);
        ...
        function handle_price_rule(price_rule, loaded_cost, estimate,
            ...
            log.debug('calc_details : ' + JSON.stringify(calc_details));
            log.debug('calc_details keys: ' + Object.keys(calc_details));

            var org_rate = calc_details.base_rate_in;
            log.debug('org_rate : ' + org_rate);
        ...
        function addUpdateCustPriceList(price_rule, price_rule_json, price, discount, domestic, international, customerTxt) {
            ...
            customerPriceList.save();
        };

        function custPLName(customer, domestic, international){
            ...
            log.debug('customer + " " + type : ' + customer + " " + type);
