...
define(
    ...
    function (record, runtime, search, format, task, nts_md_manage_price_rule,
        ...
        function generate_price_list_dom(requestBody) {
            ...
            scriptTask.scriptId = "customscript_vel_get_price_lists";
            scriptTask.deploymentId = "customdeploy_vel_get_price_lists";

            scriptTask.params = {
                custscript_price_list_customer: customer,
                custscript_price_list_location: location
            };
        ...
        function generate_price_list_int(requestBody) {
            ...
            var price_rule_results = query_price_rules_int(customer,
            ...
            if (price_rule_results.length > 0) {
                ...
                for (var i = 0; i < price_rule_results.length; i++) {
                    ...
                    if (!itemlookup.isinactive) {
                        ...
                        estimate = nts_md_manage_item_master.item_pricing(
                            estimate, price_rule);
            ...
            var search_obj = search
                .create({
                    ...
                    filters: [
                        ...
                        "AND",
                        [
                            "custrecord_nts_pr_item.custitem_vmrd_domestic",
                            "is", "T"],
                        "AND",
                        [
                            "custrecord_nts_pr_item.custitem_vmrd_sellable",
                            "is", "T"]],
            ...
            var search_obj = search
                .create({
                    ...
                    filters: [
                        ...
                        "AND",
                        [
                            "custrecord_nts_pr_item.custitem_vmrd_international",
                            "is", "T"],
                        "AND",
                        [
                            "custrecord_nts_pr_item.custitem_vmrd_sellable",
