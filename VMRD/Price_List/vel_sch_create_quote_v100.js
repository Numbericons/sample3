...
define(["N/record", "N/search", "N/task", "N/runtime", "N/error", "N/format", "SuiteScripts/_work/srvc/design_to_build/code/nts_md_manage_item_master"],
  function (record, search, task, runtime, error, format, nts_md_manage_item_master) {
    ...
    //     log.audit({
    //       title: "Reduce Time Total (seconds)",
    //       details: summary.reduceSummary.seconds,
    //     },);
    //     log.audit({
    //       title: "Max Concurrency Utilized ",
    //       details: summary.reduceSummary.concurrency,
    //     },);
    //     log.audit({
    //       title: "Usage Consumed ",
    //       details: summary.reduceSummary.usage,
    //     },);
    //     log.audit({
    //       title: "Number of Yields ",
    //       details: summary.reduceSummary.yields,
    //     },);
    //     log.audit({
    //       title: "END",
    //       details:
    ...
    function generate_price_list_dom(customer, location, estimateId) {
      ...
      if (price_rule_results.length - start_idx > nintyPercent) {
        log.debug('', 'Recursive Call to continue building estimate');
