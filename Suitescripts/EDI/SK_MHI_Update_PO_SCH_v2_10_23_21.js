...
function updatePo(rId, rec) {
    try {
        ...
        for (var i = 1; i < count; i++) {
            ...
            nlapiSetCurrentLineItemValue('item', 'custcol_po_case_serial', rec.getLineItemValue('recmachcustrecord_mhi_943_item_data_parent', 'custrecord_mhi_943_invnumber', i));
            nlapiSetCurrentLineItemValue('item', 'custcol_po_pallet_gs1_ser', rec.getLineItemValue('recmachcustrecord_mhi_943_item_data_parent', 'custrecord_mhi_943_pallet_id', i));
            nlapiSetCurrentLineItemValue('item', 'custcol_po_prod_date', rec.getLineItemValue('recmachcustrecord_mhi_943_item_data_parent', 'custrecord_mhi_943_production_date', i));
